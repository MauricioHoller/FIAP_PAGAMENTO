package com.fiap.lanchonete.producao.infrastructure.persistence.entity;
...
import com.fiap.lanchonete.producao.domain.entity.Produto;
...
public class PedidoEntity {
	...
	public PedidoEntity(Integer id,String listaProdutosPedido,
			@NotNull StatusPedido statusPedido, BigDecimal valorTotal) {
		this.id = id;
		this.listaProdutosPedido = listaProdutosPedido;
		this.statusPedido = statusPedido;
